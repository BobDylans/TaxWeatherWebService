...
public class IncomeTaxServiceLocator extends org.apache.axis.client.Service implements IncomeTaxService {
    ...
    public IncomeTaxServiceLocator() {
    }


    public IncomeTaxServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public IncomeTaxServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
