...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements example.clientDemo.WeatherWebService {
 ...
 */
    ...
    public example.clientDemo.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public example.clientDemo.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            example.clientDemo.WeatherWebServiceSoap12Stub _stub = new example.clientDemo.WeatherWebServiceSoap12Stub(portAddress, this);
    ...
    public example.clientDemo.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public example.clientDemo.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            example.clientDemo.WeatherWebServiceSoap_BindingStub _stub = new example.clientDemo.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (example.clientDemo.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                example.clientDemo.WeatherWebServiceSoap12Stub _stub = new example.clientDemo.WeatherWebServiceSoap12Stub(new java.net.URL(WeatherWebServiceSoap12_address), this);
                _stub.setPortName(getWeatherWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (example.clientDemo.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                example.clientDemo.WeatherWebServiceSoap_BindingStub _stub = new example.clientDemo.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
